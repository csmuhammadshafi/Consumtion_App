...
class Balancerecord extends StatefulWidget {
  const Balancerecord({super.key});

  @override
  State<Balancerecord> createState() => _BalancerecordState();
}

class _BalancerecordState extends State<Balancerecord> {
  final firestore = FirebaseFirestore.instance.collection('balance').snapshots();
  ...
  Future<void> _updateRecord(String docId, String title, String acc, String amount, String desc, String date, bool status) async {
    await FirebaseFirestore.instance.collection('balance').doc(docId).update({
      'title': title,
      'acc': acc,
      'amount': amount,
      'desc': desc,
  ...
  Future<void> _deleteRecord(String docId) async {
    await FirebaseFirestore.instance.collection('balance').doc(docId).delete();
  }
}
